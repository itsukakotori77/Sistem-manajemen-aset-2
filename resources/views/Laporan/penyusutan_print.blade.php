    ...
    <table class="table">
        <thead>
            <tr class="tr">
                ...
                <th class="td">Tanggal Penyusutan</th>
            </tr>
        </thead>
        <tbody>
            @foreach($data['penyusutan'] as $penyusutan)
                <tr>
                    ...
                    <td class="td"><p class="text-center">{{ $penyusutan->Nama_Aset }}</p></td>
                    <td class="td"><p class="text-center">{{ date('d/m/Y', strtotime($penyusutan->Tanggal_Penyusutan)) }}</p></td>
                </tr>
            @endforeach
        </tbody>
    </table>
